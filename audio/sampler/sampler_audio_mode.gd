...
@export var sample : SamplerSample
@export var sample_amplitude = 1.0
@export var attack : float
@export var release : float

var active_legato : SamplerPolyvoice
var polyvoices : Array[SamplerPolyvoice]
