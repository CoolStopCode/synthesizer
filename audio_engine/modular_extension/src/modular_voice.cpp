...
void Modular_Voice::_bind_methods() {
    ClassDB::bind_method(D_METHOD("set_frequency", "frequency"),  &Modular_Voice::set_frequency);
    ClassDB::bind_method(D_METHOD("get_frequency"),  &Modular_Voice::get_frequency);
    ClassDB::bind_method(D_METHOD("set_active", "active"),  &Modular_Voice::set_active);
    ClassDB::bind_method(D_METHOD("get_active"),  &Modular_Voice::get_active);
    ClassDB::bind_method(D_METHOD("set_amplitude", "amplitude"),  &Modular_Voice::set_amplitude);
    ClassDB::bind_method(D_METHOD("get_amplitude"),  &Modular_Voice::get_amplitude);

    ClassDB::bind_method(D_METHOD("bend_frequency_to", "target", "duration"), &Modular_Voice::bend_frequency_to);
    ClassDB::bind_method(D_METHOD("bend_amplitude_to", "target", "duration"), &Modular_Voice::bend_amplitude_to);

    ClassDB::bind_method(D_METHOD("process", "delta"), &Modular_Voice::process);
...
void Modular_Voice::set_frequency(const double frequency_p) { frequency = frequency_p; frequency_target = frequency_p; }
double Modular_Voice::get_frequency() { return frequency; }
void Modular_Voice::bend_frequency_to(const double target, const double duration) {
...
void Modular_Voice::set_amplitude(const double amplitude_p) { amplitude = amplitude_p; amplitude_target = amplitude_p; }
double Modular_Voice::get_amplitude() { return amplitude; }
void Modular_Voice::bend_amplitude_to(const double target, const double duration) {
...
void Modular_Voice::set_active(const bool active_p) { active = active_p; }
bool Modular_Voice::get_active() { return active; }

std::array<Modular_Voice::ModuleFunction, Modular_Voice::MODULE_TYPE_COUNT> Modular_Voice::dispatch_table = {
    Modular_Voice::process_input_module,
    Modular_Voice::process_output_module,

    Modular_Voice::process_oscillator_module,
    Modular_Voice::process_noise_module,

    Modular_Voice::process_envelope_module,
    Modular_Voice::process_filter_module,
    Modular_Voice::process_bitcrusher_module,

    Modular_Voice::process_arithmetic_module,
};

void Modular_Voice::set_layout(
...
double Modular_Voice::process(double delta) {
...
inline double Modular_Voice::read_input(
    uint32_t index,
    double* memory_data,
...
inline double Modular_Voice::read_memory(
    uint32_t index,
    double* memory_data
) {
...
inline void Modular_Voice::write_memory(
    uint32_t index,
    double value,
    double* memory_data
) {
...
inline int Modular_Voice::double_to_int(double double_p) {
    return static_cast<int>(std::round(double_p));
}

inline bool Modular_Voice::double_to_bool(double double_p) {
    return double_p != 0.0;
}

inline double Modular_Voice::bool_to_double(bool double_p) {
    return double_p ? 1.0 : 0.0;
}

inline double Modular_Voice::int_to_double(int double_p) {
    return static_cast<double>(double_p);
}

inline double Modular_Voice::lerp(double a, double b, double t) {
    return a + (b - a) * t;
}
...
void Modular_Voice::process_input_module(
    const Module &m,
    double* memory_data,
    const uint32_t* input_routes,
    double delta
...
void Modular_Voice::process_output_module(
    const Module &m,
    double* memory_data,
    const uint32_t* input_routes,
    double delta
...
void Modular_Voice::process_oscillator_module(
    const Module &m,
    double* memory_data,
    const uint32_t* input_routes,
    double delta
...
void Modular_Voice::process_noise_module(
    const Module &m,
    double* memory_data,
    const uint32_t* input_routes,
    double delta
...
void Modular_Voice::process_envelope_module(
    const Module &m,
    double* memory_data,
    const uint32_t* input_routes,
    double delta
...
void Modular_Voice::process_filter_module(
    const Module &m,
    double* memory_data,
    const uint32_t* input_routes,
    double delta
...
void Modular_Voice::process_bitcrusher_module(
    const Module &m,
    double* memory_data,
    const uint32_t* input_routes,
    double delta
...
void Modular_Voice::process_arithmetic_module(
    const Module &m,
    double* memory_data,
    const uint32_t* input_routes,
    double delta
